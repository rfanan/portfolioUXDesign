...
export default function index() {
  ...
  return (
    <>
      <motion.div variants={menuSlide} initial="initial" animate="enter" exit="exit" className="min-h-screen w-full z-20 bg-PrimaryBlack fixed right-0 top-0 text-white">
