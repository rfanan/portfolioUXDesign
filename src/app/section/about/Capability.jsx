...
export default function Capability() {
  ...
  return (
    <>
      <div className="flex mx-8 md:mx-14 lg:mx-32 xl:mx-52 justify-center py-6">
        <div className="grid grid-cols-2 w-full content-center  text-[#f2f2f2]">
          <div className=" text-sm md:text-base xl:text-lg">
            <div>{"{ Capabilities. }"}</div>
          </div>
          <div className="">
            <div className=" text-sm md:text-base xl:text-lg subpixel-antialiased gap-x-6 text-justify text-[#868686] hover:text-[#f2f2f2] transition-all duration-300 ease-in-out">
              {data.map((item, index) => {
                return (
                  <div key={index}>
                    ...
                    <div className=" py-6">
                      <div className="border border-slate-200/10 opacity-35" />
                    </div>
                  </div>
                );
              })}
